...
import 'package:core/domain/entities/episode.dart' as _i12;
...
import 'package:watch/domain/get_watchlist_status.dart' as _i13;
import 'package:watch/domain/remove_watchlist.dart' as _i16;
import 'package:watch/domain/save_watchlist.dart' as _i14;
...
class MockSaveWatchlist extends _i1.Mock implements _i14.SaveWatchlist {
  ...
  _i4.WatchRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeWatchRepository_2()) as _i4.WatchRepository);
  @override
  _i6.Future<_i3.Either<_i7.Failure, String>> execute(_i15.Watch? watch) =>
