...
void main() {
  ...
  final tTvDetailModel = TvDetailModel(backdropPath: "backdropPath", genres: [tGenreModel], id: 1, numberOfEpisodes: 1, numberOfSeasons: 1, originalName: "originalName", overview: "overview", posterPath: "posterPath", seasons: [tSeasonModel], voteAverage: 1.0);
